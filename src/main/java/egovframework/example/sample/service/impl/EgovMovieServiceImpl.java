...
public class EgovMovieServiceImpl extends EgovAbstractServiceImpl implements EgovMovieService {
	...
	public void insertData(String indexName, MovieIndex movie, String id) throws IOException {
		IndexRequest<MovieIndex> indexRequest = new IndexRequest.Builder<MovieIndex>().index(indexName).id(id).document(movie).build();
	...
	public void updateData(String indexName, MovieIndex movie, String id) throws IOException {
		UpdateRequest<MovieIndex, MovieIndex> updateRequest = new UpdateRequest.Builder<MovieIndex, MovieIndex>()
				.id(id)
				.index(indexName)
				.doc(movie)
				.build();
		UpdateResponse<MovieIndex> updateResponse = client.update(updateRequest, MovieIndex.class);
	...
	public SearchResponse<MovieIndex> searchAll(String indexName) throws IOException {
		try {
			...
			SearchResponse<MovieIndex> searchResponse = client.search(builder.build(), MovieIndex.class);
	...
	public SearchResponse<MovieIndex> search(String indexName, String query) throws IOException {
		...
		SearchResponse<MovieIndex> searchResponse = client.search(textSearchRequest, MovieIndex.class);
